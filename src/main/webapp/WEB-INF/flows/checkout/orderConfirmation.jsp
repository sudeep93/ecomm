                       ...
                       <div class="txt-center">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                <strong>Name </strong>
                              ${order.cart.customer.customerName}<br>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                ...
                                <p>Excepted Delivery Date: <fmt:formatDate type="date" value="${now}" /></p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach var="c" items="${order.cart.cartItems}">
                                    <tr>
                                        <td class="col-md-9"><em>${c.product.name}</em></td>
                                        <td class="col-md-1" style="text-align: center">${c.quantity}</td>
                                        <td class="col-md-1" style="text-align: center">${c.product.price}</td>
                                        <td class="col-md-1" style="text-align: center">${c.totalPrice}</td>
                                    </tr>
                                </c:forEach>

                                <tr>
                                  <td class="text-right">
                                        <h4><strong>Payment </strong>method is <strong>CASH ON DELIVERY</strong></h4>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td class="text-right">
